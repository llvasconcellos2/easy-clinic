...
(function (global) {
  ...
  function initIcd10List() {
    initDT("icd10-table", ICD10.find().fetch(), [
  ...
  function initSettingsForm() {
    ...
    if (s.notifications)
      $form.find("[name=notifications]").val(s.notifications);
  ...
  function initDocumentModelList() {
    ...
    var typeLabels = {
      form: t("patients_records"),
      prescription: t("dashboard_prescriptions"),
      exam_request: t("dashboard_exam-requests"),
      medical_certificate: t("dashboard_certificates"),
    };
    initDT(
  ...
  function initUserList() {
    ...
    $("#new-user-btn").on("click.ripUsers", function () {
      loadUserForm(null);
    });
  ...
  global._afterRender = function (routeName, params, query) {
    ...
    if (routeName === "examCatalogEdit")
      initExamCatalogForm(params && params.id);
    ...
    if (routeName === "documentModelEdit")
      initDocumentModelForm(params && params.id);
