Template.patientTimeLine.inheritsHelpersFrom("patientRecord");

// Template.patientTimeLine.helpers({
// 	selected: function(first){
// 		console.log('first=', first);
//         if(first) return 'class="selected"';
//     },
// });
...
var runTimeline = function () {
  ...
  function updateTimelinePosition(string, event, timelineComponents) {
    ...
    translateTimeline(timelineComponents, 0, timelineWidth - timelineTotWidth);
    return;
  ...
  // ORIGINAL FUNCTION
  function setDatePositionOLD(timelineComponents, min) {
  ...
  function daydiffOLD(first, second) {
